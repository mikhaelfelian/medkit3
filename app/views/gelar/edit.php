            ...
            <div class="col-12">
                <div class="card rounded-0">
                    <div class="card-header">
                        <h3 class="card-title">Edit Data Gelar</h3>
                    ...
                    <form action="<?= BaseRouting::url('gelar/update/' . $data->id) ?>" method="POST">
                        <?= BaseForm::csrf() ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" id="gelar" name="gelar" 
