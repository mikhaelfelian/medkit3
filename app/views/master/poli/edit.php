...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card rounded-0">
            <form action="<?= BaseRouting::url('poli/update/' . $data->id) ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Kode</label>
                                <input type="text" class="form-control rounded-0" value="<?= $data->kode ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Nama Poli <span class="text-danger">*</span></label>
                                <input type="text" class="form-control rounded-0" name="poli" required 
                                       value="<?= $data->poli ?>" placeholder="Masukkan nama poli...">
                            </div>
                            <div class="form-group">
