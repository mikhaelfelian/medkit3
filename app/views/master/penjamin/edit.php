...
<section class="content">
    <div class="container-fluid">
        <div class="card rounded-0">
            <form action="<?= BaseRouting::url('penjamin/update/' . $data->id) ?>" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" id="kode" value="<?= $data->kode ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" id="penjamin" name="penjamin" 
                               value="<?= htmlspecialchars($data->penjamin) ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control rounded-0" id="persen" name="persen" 
                                   value="<?= $data->persen ?>" required min="0" max="100" step="0.1">
