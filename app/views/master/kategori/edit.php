        ...
        <div class="row">
            <div class="col-12">
                <div class="card rounded-0">
                    ...
                    <form action="<?= BaseRouting::url('kategori/update/' . $data->id) ?>" method="POST">
                        <?= BaseForm::csrf() ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" id="kategori" name="kategori" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="status1" name="status" 
                                           value="1" <?= ($data->status == '1' || $data->status == 1) ? 'checked' : '' ?>>
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="status0" name="status" 
                                           value="0" <?= ($data->status == '0' || $data->status == 0) ? 'checked' : '' ?>>
