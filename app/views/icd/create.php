            ...
            <div class="col-12">
                <div class="card rounded-0">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Data ICD</h3>
                    ...
                    <form action="<?= BaseRouting::url('icd/store') ?>" method="POST">
                        <?= BaseForm::csrf() ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" id="icd" name="icd" required>
                            </div>
