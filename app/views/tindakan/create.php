...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card rounded-0">
            ...
            <form
                action="<?= $data ? BaseRouting::url('tindakan/update/' . $data->id) : BaseRouting::url('tindakan/store') ?>"
                method="POST">
                ...
                <div class="card-body rounded-0">
                    <div class="form-group">
                        ...
                        <select name="id_kategori" id="id_kategori" class="form-control select2 rounded-0" required>
                            ...
                            foreach ($kategoris as $kategori):
                                ?>
                                <option value="<?= $kategori->id ?>" <?= isset($data) && $data->id_kategori == $kategori->id ? 'selected' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0" id="item" name="item" value=""
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control rounded-0 currency" id="harga_jual" name="harga_jual"
                                value="" placeholder="Masukkan harga tindakan" onkeyup="formatCurrency(this)" required>
                        </div>
                    </div>
                    <div class="row">
