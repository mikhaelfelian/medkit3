            ...
            <div class="col-12">
                <div class="card rounded-0">
                    <div class="card-header">
                        <h3 class="card-title">Detail Data Tindakan</h3>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            <tr>
                                <th width="200" class="bg-light">Kode</th>
                                <td><?= $data->kode ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="bg-light">Nama Tindakan</th>
                                <td><?= $data->item ?></td>
                            </tr>
                            <tr>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="<?= BaseRouting::url('tindakan/edit/' . $data->id) ?>" class="btn btn-warning rounded-0">
